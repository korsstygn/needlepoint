...
# Function to save the analysis report to a CSV file
def save_report(report, file_path):
    try:
        # Extract data from the report for CSV generation
        keyword_data = [{"Keyword": kw, "Frequency": freq} for kw, freq in sorted_keywords]
        ...
        print("Report saved successfully as CSV.")
    except Exception as e:
        print(f"Error saving report as CSV: {e}")

# Main function
def main():
    input_file_path = "NewsDB-Python/datatsets/dataset.csv"  # Replace with your CSV file path
    output_file_path = "KW_FREQ_report.csv"  # Replace with the desired output file path
