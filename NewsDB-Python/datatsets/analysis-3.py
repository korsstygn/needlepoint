...
articles_with_top_keywords = df.loc[df['Keywords'].str.contains('|'.join(five_most_common)), ['Title', 'Author', 'Permalink', 'Description']] # filtering dataframe to include articles with any of the five most frequent keywords
...
with open('results.html', 'w') as f:
    ...
    f.write('<body><h1>Top 10 keywords and their frequency</h1>')
