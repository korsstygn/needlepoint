...
def create_word_clouds(file_path):
    ...
    for column in selected_columns:
        ...
        wordcloud = WordCloud(width=1600, height=1024, background_color='#FAFAFA').generate(text)
        ...
        with open(html_filename, 'w') as f:
            f.write('<img src="data:image/svg+xml;base64,' + b64encode(wordcloud.to_svg().encode()).decode() + '" width="1600" height="1024"/>')
...
file_path = 'NewsDB-Python/datasets/dataset.csv'
